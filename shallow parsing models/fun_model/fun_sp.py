...
import id_feature_bigram_sp as idf
...
if __name__ == '__main__':
    ...
    #mode = 'by_sent'
    mode = 'by_doc'
    train,test,val = getData(test=0.15, val=0.15, tags = ['FUN'], mode=mode,filter_empty=True)
    ...
    #epochs = 30 # para ext features
    epochs = 15 # para id features
    learning_rate = 1
    reg = 0
