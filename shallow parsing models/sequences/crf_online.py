...
class CRFOnline(dsc.DiscriminativeSequenceClassifier):
    ...
    def train_supervised(self, dataset):
        ...
        #self.parameters = 1000 + np.random.normal(0,1,self.feature_mapper.get_num_features())*100
    ...
    def gradient_update(self, sequence, eta):
        ...
        initial_scores, transition_scores, final_scores, emission_scores = \
            self.compute_scores_backup(sequence)
        ...
        for state in range(num_states):
            ...
            self.parameters[state_initial_features] -= eta * state_posteriors[2, state]
        ...
        for state in range(num_states):
            ...
            self.parameters[state_final_features] -= eta * state_posteriors[pos, state]
